...
<div class="mx-auto max-w-3xl p-4 sm:p-6 lg:p-8">
  <div class="prose-a:underline">
    ...
    <p>
      ...
      <a href="mailto:logolicusz@gmail.com">logolicusz@gmail.com</a>
      .
    </p>
    ...
    <p>
      ...
      track overall trends in my website traffic, not individual visitors.
      <span class="font-semibold">Absolutely no personal data is collected for analytics.</span>
    </p>
    <p>
